...
register_report_routes(csilk_app_t* app)
{
    csilk_app_get_ext(app,
                      ...
                      report_usecase_expense_monthly,
                      nullptr,
                      nullptr,
    ...
    csilk_app_get_ext(app,
                      ...
                      report_usecase_expense_category,
                      nullptr,
                      nullptr,
                      "Expense by category",
    ...
    csilk_app_get_ext(app,
                      ...
                      report_usecase_asset_breakdown,
                      nullptr,
                      nullptr,
                      "Asset breakdown",
    ...
    csilk_app_get_ext(app,
                      ...
                      report_usecase_transaction_performance,
                      nullptr,
                      nullptr,
    ...
    csilk_app_get_ext(
        ...
        report_usecase_multi_currency_summary,
        nullptr,
        nullptr,
    ...
    csilk_app_get_ext(
        app,
        "/api/summary",
        report_usecase_dashboard_summary,
        nullptr,
        nullptr,
        "Dashboard summary",
